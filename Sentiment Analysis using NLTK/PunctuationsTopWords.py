...
print "Maximum Entropy classifier accuracy of raw data without punctuations for top 1000 words"

# list all the punctuations in the string
...
def word_features(words):
    return dict([(word, True) for word in words if word in top_words and word not in punctuations])
